  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className="font-mono text-[10px] text-zinc-500 dark:text-zinc-600 mb-0.5">{method.label}</p>
        <p className="text-sm font-medium text-zinc-800 dark:text-zinc-200 truncate">{method.value}</p>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mb-12">
          ...
          <p className="mt-3 text-zinc-500 dark:text-zinc-500 max-w-lg leading-relaxed text-sm">
            Available for new opportunities, freelance work, or a good technical conversation.
        ...
        <div className="grid lg:grid-cols-[1fr_300px] gap-10 items-start">
          ...
          <div>
            <p className="font-mono text-xs text-zinc-400 dark:text-zinc-600 mb-4">// pick your channel</p>
            ...
            {/* Location + timezone */}
            <div className="mt-6 flex flex-wrap items-center gap-x-6 gap-y-2 font-mono text-xs text-zinc-500 dark:text-zinc-600">
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* QR card */}
            <div className="flex flex-col items-center gap-4 p-6 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950/50">
              <p className="font-mono text-[10px] text-zinc-400 dark:text-zinc-600 self-start">// scan_to_connect()</p>

              {/* QR code image */}
              <div className="relative p-2 rounded-lg bg-zinc-900 dark:bg-zinc-900 border border-zinc-700 dark:border-zinc-700">
                <img
                  src={qrSrc}
                ...
                <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 flex items-center gap-1.5 bg-zinc-900 border border-zinc-700 rounded-full px-2.5 py-0.5 whitespace-nowrap">
                  ...
                  <span className="font-mono text-[9px] text-zinc-400">WhatsApp</span>
                </div>
              </div>

              <p className="font-mono text-[10px] text-zinc-500 dark:text-zinc-600 text-center mt-2">
                Opens chat on WhatsApp
              </p>
            </div>
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">Download Resume</p>
                <p className="font-mono text-[10px] text-zinc-500 dark:text-zinc-600 mt-0.5">PDF · Backend Engineer</p>
              </div>
