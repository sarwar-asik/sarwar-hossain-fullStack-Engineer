    ...
    <div className="flex flex-col items-center gap-5 mb-10 lg:mb-0">
      ...
      <div className="relative w-40 h-40 shrink-0">
        ...
        <div className="w-full h-full rounded-full overflow-hidden bg-zinc-800 dark:bg-zinc-800 flex items-center justify-center">
          {photo ? (
            <img src={photo} alt={`${name} (Sarwar Asik) – Software Engineer & Backend Engineer`} className="w-full h-full object-cover object-top" loading="lazy" />
          ) : (
            <div
...
export default function About() {
  ...
  return (
    <section id="about" aria-label="About Sarwar Hossain | Sarwar Asik" className="py-24 bg-white dark:bg-zinc-900 border-t border-zinc-200 dark:border-zinc-800">
