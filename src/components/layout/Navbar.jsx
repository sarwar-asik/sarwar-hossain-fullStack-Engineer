...
export default function Navbar({ theme, onThemeToggle }) {
  ...
  return (
    <>
      ...
      >
        <nav className="max-w-6xl mx-auto px-6 flex items-center justify-between">
          ...
          <a href="#" aria-label="Home" className="flex items-center gap-2.5 group">
            ...
            <span className="text-sm font-medium text-zinc-400 hidden sm:block group-hover:text-zinc-200 transition-colors">{profile.name}</span>
          </a>
      ...
      {/* Mobile overlay */}
      {menuOpen && <div className="fixed inset-0 z-40 lg:hidden bg-black/60 backdrop-blur-sm" onClick={() => setMenuOpen(false)} />}
